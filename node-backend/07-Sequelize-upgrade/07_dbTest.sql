use sesac_test_users;

select * from user;

delete from user where name = '테스터1';

DELETE FROM user WHERE id >= 8 AND id <= 18;

use sesac_test;

create database database_test default character set utf8mb4 default collate utf8mb4_general_ci;
use database_test;
show tables;
