...
function Chatting4() {
  ...
  return (
    <>
      ...
      <div className="container absolute border-2 border-slate-200 shadow-xl rounded-2xl w-[320px] h-[500px] translate-x-[-50%] left-[50%]">
        {userId ? (
          <>
            <div className="top-2 px-5 pt-2 font-bold text-xl text-blue-500">
              {userId}님 환영합니다.
            </div>
            <div className="p-4">
